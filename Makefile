...
SRC_BONUS =	./src/main.c \
			...
			./src/builtins/cd.c \
			./src/builtins/exit.c \
			./src/expander/expander_bonus.c \
			./src/expander/expand_wildcard_bonus.c \
			./src/expander/wildcard_utils_bonus.c \
			./src/execution/execution_bonus.c \
			./src/execution/execute_logical_bonus.c \
